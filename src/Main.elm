...
--
--import Parser
--import FastParser as FP
--import LangParser2 as LP2
--
----------------------------------------------------------------------------------
---- Model
----------------------------------------------------------------------------------
...
--        ]
--    (color, status, body) =
--      case (FP.parseE model, LP2.parseE model) of
--        (Ok exp1, Ok exp2) ->
--          ("#008800"
--          , "Success"
--          , Html.div
--              []
--              [ Html.pre [] [ Html.text <| toString exp1 ]
--              , Html.br [] []
--              , Html.pre [] [ Html.text <| toString exp2 ]
--              , Html.br [] []
--              , Html.pre [] [ Html.text <| "Matches? " ++ toString ((toString exp1) == (toString exp2)) ]
--              ]
--          )
--        (Ok exp1, Err err2) ->
--          ("#FF0000", "Failure", Html.div [] [])
--        (Err err, _) ->
--          ("#880000"
--          , "Error"
--          , Html.div
